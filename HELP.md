...
* The original package name 'photo-shoot.backend-workspace' is invalid and this project uses 'photoshoot.backendworkspace' instead.
...
* [OAuth2 Client](https://docs.spring.io/spring-boot/docs/3.0.9/reference/htmlsingle/#web.security.oauth2.client)
